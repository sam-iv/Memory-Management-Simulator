...
public class Parser {
	...
	/**
	 * Method to extract the Process id and a list of Segment size with some
	 * parameters
	 * 
	 * @param process_string of the form pid, sid1_size, sid2_size ... example: 1,
	 *                       100, 200
	 * @param process_string of the form pid, [sid1_size; size1_arg1; size1_arg2,
	 *                       ...], ... example: 1, [100; 0], [200; 1], [300; 0; 2;
	 *                       3]
	 * @return comp and ArrayList of components from process_string example comp[0]
	 *         = pid and comp[1] = {100, 0}
	 */
	...
	public ArrayList<String>[] parseInputString(String process_string) {
		...
		/*
		 * for (int i =0; i<size; i++){ System.out.println(comp[i].toString()); }
		 */
